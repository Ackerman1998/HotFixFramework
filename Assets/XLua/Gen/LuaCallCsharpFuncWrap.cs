...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaCallCsharpFuncWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LuaCallCsharpFunc);
        ...
        {
            return LuaAPI.luaL_error(L, "LuaCallCsharpFunc does not have a constructor!");
        }
		    ...
		    try {
                ...
                
                {
                    string _assetName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = LuaCallCsharpFunc.LoadAssetAsync( _assetName );
                        translator.Push(L, gen_ret);
