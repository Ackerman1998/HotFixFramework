...
-- 	--Log.Print("Awake coroutine ... ")
-- 	local args = SafePack(...)
-- 	--func执行后运行
-- 	while func do
-- 		local ret = SafePack(func(SafeUnpack(args)))--func返回值
-- 		__RecycleCoroutine(coroutine.running())
-- 		args = SafePack(coroutine.yield(SafeUnpack(ret)))
-- 		func = args[1]
-- 		table.remove(args, 1)
...
-- 		co = table.remove(co_pool)
-- 	else
-- 		co = coroutine.create(_Coroutine)
-- 	end
-- 	return co
-- end
